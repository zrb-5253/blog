...
这是一段普通的文字，<span style="color: #e74c3c; font-family: 'Comic Sans MS', cursive; font-size: 5em; font-weight: bold; background-color: #FBEEE6; padding: 0.2em 0.5em; border-radius: 4px;">这是需要特别突出显示的那一句文字。</span> 后面的文字又恢复了正常。
